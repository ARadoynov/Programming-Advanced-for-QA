...
public class SongTests
{
    ...
    {
        // Arrange
        string[] songs = { "Pop_Song1_3:30", "Rock_Song2_4:15", "Pop_Song3_3:00", "Rock_SoFarAway_4:00" };
        string expected = $"Song2{Environment.NewLine}SoFarAway";
    ...
    public void Test_AddAndListSongs_ReturnsEmptyString_WhenNoSongsMatchWantedList()
    {
        ...
        // Act
        string result = _song.AddAndListSongs(songs, "Disco");
